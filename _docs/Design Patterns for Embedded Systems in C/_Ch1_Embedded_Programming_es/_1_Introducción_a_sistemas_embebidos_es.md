...
1.1.5 Codesarrollo con Hardware
...
|   |   |
|---|---|
|return|me->queue->isEmpty(me->queue) &&  <br>me->outputQueue->isEmpty(me->outputQueue) &&|
...
|   |   |
|---|---|
|return|me->queue->getSize(me->queue) +  <br>me->outputQueue->getSize(me->outputQueue) +|
